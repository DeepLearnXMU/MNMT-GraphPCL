...
def parse_args():
    ...
    parser.add_argument('--cllamb', type=float, default=1.0,)
    parser.add_argument('--clproj', type=str,)
    parser.add_argument('--hardtau', type=float, default=1.0)
    parser.add_argument('--hardins_start', type=int, default=0)
    parser.add_argument('--maxnum_neggraph', type=int, default=5)
    parser.add_argument('--mtrep', type=int, default=0)
    parser.add_argument('--wocl', type=int, default=1)
    parser.add_argument('--pace', type=float, default=1.0)
    parser.add_argument('--hardtype', type=str)
    parser.add_argument('--sfgtype', type=str, help='all, one, ind')
